...
public class DmlServlet extends XtextServlet {
  ...
  public void init() {
    try {
      ...
      DmlWebSetup _dmlWebSetup = new DmlWebSetup(executorServiceProvider);
      _dmlWebSetup.createInjectorAndDoEMFRegistration();
    } catch (Throwable _e) {
